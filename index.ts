...
//type aliases alow defining types with a custom name(an alias)
//type aliases can be used for primitives like string or more complex  such as objects and arrays
type CarYear = number
type CarType = string
...
//interfaces can extend each others definition, extending an interface means you are creating a new interface with the same properties as the original plus something new
